...
﻿ **USECASE DIAGRAM** 
   ...
   **Usecase là gì? Các thành phần của usecase.**
1. Usecase là gì?
...
3. Các mối quan hệ trong sơ đồ usecase
...
2. Các chức năng sẽ được mô tả bằng các hình eclipse
...
3. Đối với đăng nhập, SV có thể lựa chọn đăng nhập bằng email hoặc google.
...
4. Khi đăng nhập, có khi các bạn thỉnh thoảng sẽ bị quên mất mật khẩu. Chức năng quên mật khẩu sẽ được “extend” (mở rộng) từ chức năng đăng nhập.
...
5. Khi muốn tham gia lớp học, chúng ta bắt buộc phải đang nhập vào mới có thể tham gia được. Vì vậy, chức năng tham gia lớp học sẽ được “include”(bao gồm) từ chức năng đăng nhập.
